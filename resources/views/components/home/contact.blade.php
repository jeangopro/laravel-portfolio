        ...
        <div class="relative p-8 bg-white rounded-lg shadow-lg dark:bg-slate-900 sm:p-12">
          <form action="/contact/submit" method="POST" x-data="{
            ...
            <template x-if="successMessage">
              <div x-text="successMessage" class="px-6 py-4 mb-4 text-gray-100 bg-green-600"></div>
            </template>
            @csrf
            <div class="mb-6">
              <x-forms.input placeholder="Your Name" name="name" x-model="formData.name" ::class="errors.name ? 'border-red-500 focus:border-red-500' : ''">
              </x-forms.input>
